...
export const ContactContent = {
  body:
    "To get a quote or even just to have a chat, please feel free to  get in touch. We will be happy to answer any questions you may have.",
  subtitle: "call us on:",
}

export const ContactDetails = {
  phone: "441234567890",
  email: "info@ecoevuk.co.uk",
}

export const ChargersContent = [
  {
    image: [
      require("../assets/images/chargers/eo/black.png").default,
      require("../assets/images/chargers/eo/blue.png").default,
      require("../assets/images/chargers/eo/silver.png").default,
      require("../assets/images/chargers/eo/white.png").default,
    ],
    title: "EO Mini Pro",
    cardBody:
  ...
  {
    image: [
      require("../assets/images/chargers/andersen/charcoal.png").default,
      require("../assets/images/chargers/andersen/cotswoldoak.png").default,
      require("../assets/images/chargers/andersen/frenchwalnut.png").default,
      require("../assets/images/chargers/andersen/malmoblue.png").default,
      require("../assets/images/chargers/andersen/nearlyblack.png").default,
      require("../assets/images/chargers/andersen/puttystone.png").default,
      require("../assets/images/chargers/andersen/ruby.png").default,
      require("../assets/images/chargers/andersen/sorongteak.png").default,
      require("../assets/images/chargers/andersen/steel.png").default,
    ],
    title: "Andersen A2",
    cardBody:
  ...
  {
    image: [
      require("../assets/images/chargers/project/noapp.jpg").default,
      require("../assets/images/chargers/project/projectapp.jpg").default,
    ],
  ...
  {
    image: [
      require("../assets/images/chargers/podpoint/universal.jpg").default,
      require("../assets/images/chargers/podpoint/tethered.png").default,
    ],
    title: "Podpoint solo",
    cardBody:
...
export const AboutContent = {
  ...
  avatar: {
    paul: {
      ...
      body:
        "The founder of <span style='color:#27AE60;'>ECO</span><span style='color:#205FCE;'>EV</span><small style='color:#27AE60;'>UK</small> Joe has been a builder, and a electrician for over 30 years in the local area.",
    },
    dad: {
      image: require("../assets/images/dad.png").default,
